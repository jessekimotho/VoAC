...
<main class="post-shell shell">
	...
	{:else}
		<article>
			...
			<section class="comments-section" aria-labelledby="comments-title" style="margin-top: 4rem;">
				<div>
			...
			{#if data.related.length}
				<section class="related" aria-labelledby="related-title" style="margin-top: 4rem;">
